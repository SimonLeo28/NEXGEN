...
export default function Home() {
  return (
    <>
    <div>
   <div className="flex flex-col justify-center items-center h-[400px] bg-white">
   ...
   <div className="flex justify-center items-center gap-9 bg-white h-[400px] ml-[50px] mr-[50px] rounded-[10px]">
   ...
   <div className="flex flex-col gap-[100px] justify-center items-center h-[1000px] ml-20 mr-20">
